...
public sealed partial class ChatEntryControl : BoxContainer
{
    ...
    private void OnFileLoaded(ContentFile file)
    {
        ...
        {
            Texture = texture, Stretch = TextureRect.StretchMode.KeepAspectCentered, RectClipContent = true, MinSize = new Vector2(200)
        };
